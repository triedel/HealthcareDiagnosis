...
public class Basics {
	...
	public static void main(String[] args) {
				...
				if (trueA==0){
					...
					if (realage<=12){
						...
						if (trueA==0){
							...
							System.out.println("Do you have diarrhea, yes or no?");
				...
				wasabi = medicine.compareToIgnoreCase("1nocghnosnznofvrnocngnohdcyesbdcnowre");
				if (wasabi==0){
					System.out.print("Your diagnosis is that you have Gastralgia (stomach ache)");
				}
				john = medicine.compareToIgnoreCase("1yescghyessnznofvryescngnohdcnobdcnowre");
				if (john==0){
					System.out.println("Your diagnosis is that you have Nasopharyngitis (Common Cold)");
				}
				jose = medicine.compareToIgnoreCase("1nocghnosnznofvrnocngyeshdcnobdcnowre");
				if (jose==0){
					System.out.println("Your diagnosis is that you have Cephalgia (Headache)");
				}
				bob = medicine.compareToIgnoreCase("1yescghnosnznofvryescngnohdcnobdcnowre");
				if (bob==0){
					System.out.println("Your diagnosis is that you have Pharyngitis (Sore Throat)");
